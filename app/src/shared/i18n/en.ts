...
export const en: Record<keyof typeof ja, string> = {
  ...
  'detail.originalCapturedAt': 'Originally captured',
  ...
  'settings.importHint': 'Adds images and metadata to your library, kept separate from your own captures. Their capture time is set to the time of import; the original is kept as "Originally captured" in the details. Importing the same folder again adds duplicates, so take care.',
