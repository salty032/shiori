...
export const en: Record<keyof typeof ja, string> = {
  ...
  'viewer.legendGap.desc': "Frames of the original video are absent from the table at this point. Stepping stops at each estimated position, but no corresponding picture exists, so the preceding picture remains visible.",
  ...
  'viewer.frameGapAfterHint': 'The page never reported {count} frames right after this one. There is no picture for those positions, but frame stepping stops at each estimated position.',
  'viewer.frameGapAfterEstimated': '~{count} frames missing',
  'viewer.frameGapAfterEstimatedHint': 'The page stopped reporting frames right after this one. The count of {count} is estimated from picture boundaries retained in the recording. If the real count differs, every frame number below this point shifts by the same amount.',
  'viewer.frameGapUnknown': 'gap - frame count unknown',
  'viewer.frameGapUnknownHint': 'The page failed to report {count} source frames after this point. The recording does not retain enough picture boundaries to estimate how many animation frames are missing.',
  'viewer.frameInGapEstimated': 'estimated gap - no picture',
  'viewer.frameInGapEstimatedHint': "You are within an estimated gap of {count} animation frames. There is no recorded picture for this position, so the picture shown belongs to the preceding measured frame {cur}. The frame number and position are estimates, and this position cannot be marked in the timesheet.",
  ...
  'whatsNew.historyTitle': 'What’s new',
  ...
  'detail.unreliableHint': 'The pictures in this recording stop lining up with the frames of the original video. Do not use it to count frame timing.',
  'detail.uncapturedFrames': '{count} frames missed',
  'detail.uncapturedFramesHint': "At {count} frames, no dedicated picture was captured and the preceding frame's picture is shown. This is separate from the number of unreported browser frames.",
  'detail.memo': 'Notes',
  ...
  'settings.captureMoveConflict': 'Nothing was moved because a file of the same name is already in the destination ({path}). Move that file elsewhere, or choose an empty folder.',
  ...
  'settings.storageHint': 'Everything you capture is stored here. If you change it, what you have already captured is moved to the new folder too (Shiori shows how many files and how much space, and asks first).',
  ...
  'settings.captureResizeTarget': 'Images',
