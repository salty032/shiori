...
export const en: Record<keyof typeof ja, string> = {
  ...
  'viewer.frameGapAfterHint': 'The page never reported {count} frames right after this one. Frame stepping does stop on those positions, but there is no picture for them. You cannot count frame timing across this point, but the rest of the recording counts normally.',
  'viewer.frameInGap': 'missing - no picture',
  'viewer.frameInGapHint': 'The page never reported this frame, so there is no picture for it. What you see is frame {cur}, the frame before the gap. You cannot mark this position. The gap runs {count} frames in total.',
  'viewer.frameInGapEstimated': '~missing - no picture',
  'viewer.frameInGapEstimatedHint': 'The page never reported this frame, so there is no picture for it. What you see is frame {cur}, the frame before the gap. You cannot mark this position. The gap length of {count} frames is estimated from the surrounding timestamps and has not been confirmed; if the real count differs, every frame number below this point shifts by the same amount.',
  'viewer.frameGapAfterEstimated': '~{count} frames missing',
  'viewer.frameGapAfterEstimatedHint': 'The page stopped reporting frames right after this one. The count of {count} is estimated from the surrounding timestamps and has not been confirmed. If the real count differs, every frame number below this point shifts by the same amount.',
  ...
  'detail.uncapturedFramesEstimated': '~{count} frames missed',
  'detail.uncapturedFramesEstimatedHint': "{count} frames were not captured. For the stretches where the frames are absent from the table, the count is estimated from the surrounding timestamps. If the real count differs, every frame number below them shifts by the same amount. Stepping tells you at the frame just before each one.",
  'detail.memo': 'Notes',
