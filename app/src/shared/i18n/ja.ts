...
export const ja = {
  ...
  'viewer.frameGapAfterHint': 'このコマの次に {count} コマぶん、ページからコマの知らせが届いていません。その位置の絵はありませんが、コマ送りでは推定位置に1コマずつ止まります。',
  ...
  'viewer.frameGapAfterEstimatedHint': 'このコマの次に、ページからコマの知らせが届いていない区間があります。{count} コマというのは録画に残った絵の境界から出した推定です。枚数が違えば、ここから下のコマ番号もその分ずれます。',
  'viewer.frameGapUnknown': '抜け・コマ数未確認',
  'viewer.frameGapUnknownHint': 'この先でページから {count} フレームぶん通知が届いていません。録画に絵の境界が残っておらず、アニメとして何コマ抜けたかは推定できません。',
  'viewer.frameInGapEstimated': '推定の抜け・絵なし',
  'viewer.frameInGapEstimatedHint': 'アニメとして推定した抜け {count} コマの中にいます。この位置に対応する録画画像は無いため、映っているのは手前の実測コマ {cur} の絵です。コマ番号と位置は推定で、この位置にはタイムシートを打てません。',
  ...
  'whatsNew.historyTitle': 'これまでの変更点',
