...
export const ja = {
  ...
  'error.startupFailed':
    ...
    'PC を再起動してから、もう一度お試しください。直らない場合は、下の1行を添えてご連絡ください。\n\n' +
    '{detail}',
  ...
  'dialog.dbRestore.detail':
    '{date} に取った退避から戻せます。\n\n' +
    '戻すと、それ以降に登録したタグ・メモ・タイムシートの打鍵は失われます。壊れたファイルは\n' +
    '消さずに backups フォルダへ残すので、後から取り出すことはできます。\n\n' +
    '画像と動画そのものは別のファイルなので、どちらを選んでも消えません。',
  'dialog.dbRestore.restore': '退避から戻す',
  'dialog.dbRestore.quit': '終了する',
  'error.dbCorruptNoBackup':
    'データベースが壊れており、戻せる退避がありませんでした。\n\n' +
    '画像と動画そのものは別のファイルなので消えていません。タグ・メモ・タイムシートの打鍵は\n' +
    '失われます。次のファイルを退避してから、Shiori をもう一度起動してください。\n\n' +
    '{path}',
  'error.dbRestoreFailed':
    ...
    '{detail}',
  'notice.dbRestored':
    'データベースが壊れていたため、{date} の退避から戻しました。それ以降に登録した内容は含まれていません。',
  'notice.dbBackupFailed':
    'データベースの退避を取れませんでした。この起動で作りを変えているため、戻したいときに戻せません。ディスクの空きを確認してください。',
