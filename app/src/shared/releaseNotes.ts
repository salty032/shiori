...
export const RELEASE_NOTES: Record<string, Record<Lang, string[]>> = {
  '1.2.0': {
    ja: [
      ...
      '個別に取り込めなかったコマには「流用」または「要確認」と表示されます。コマ送りをしても映像が変わらない場合に、元の動画でも同じ映像が続いているのか、録画時にコマを取り込めなかったのかをその場で確認できます。',
      'コマ単位の精度を保証できる素材は、24 / 29.97 / 30fps です。60fps の素材も録画できますが、取り込めなかったコマは「流用」または「要確認」と表示されます。',
