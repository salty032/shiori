...
export const s: Record<string, CSSProperties> = {
  ...
  viewToggleBtn: { position: 'relative' as const, zIndex: 1, width: 34, height: 28, padding: 0, display: 'flex', alignItems: 'center', justifyContent: 'center', background: 'none', border: 'none', borderRadius: 3, color: '#8a92ab', cursor: 'pointer' },
  thumbSizeControl: { position: 'relative' as const, display: 'flex', alignItems: 'center' },
  thumbSizeBtn: { position: 'relative' as const, zIndex: 1, width: 30, height: 28, background: 'none', border: 'none', borderRadius: 3, color: '#8a92ab', cursor: 'pointer', fontSize: font.xs, fontWeight: 800, padding: 0 },
  ...
  segSlider: { position: 'absolute' as const, top: 1, left: 1, height: 26, borderRadius: 3, background: 'rgba(91,112,255,0.42)', boxShadow: 'inset 0 0 0 1px rgba(148,160,255,0.6), 0 1px 3px rgba(0,0,0,0.35)', pointerEvents: 'none' as const, zIndex: 0, transition: 'transform 0.22s cubic-bezier(.22,1,.36,1), width 0.22s cubic-bezier(.22,1,.36,1)' },
  ...
  searchDateHint: { padding: '6px 12px', color: '#6a7290', fontSize: font.xs },
  ...
  smartFolderEmpty: { fontSize: font.xs, color: '#58627f', padding: '3px 0 2px', lineHeight: 1.5 },
  smartFolderCreateInput: { flex: 1, minWidth: 0, height: 28, background: '#101218', border: '1px solid #3b4355', borderRadius: 3, color: '#dce3f2', padding: '0 8px', fontSize: font.sm, fontWeight: 700, outline: 'none', boxSizing: 'border-box' as const },
  smartFolderAddIconBtn: { width: 28, height: 28, flexShrink: 0, display: 'flex', alignItems: 'center', justifyContent: 'center', background: 'rgba(34,197,145,0.12)', border: '1px solid rgba(34,197,145,0.42)', borderRadius: 3, color: '#54d6a8', cursor: 'pointer', padding: 0, fontSize: 14, fontWeight: 900, lineHeight: 1, boxSizing: 'border-box' as const },
  smartFolderHeaderAddBtn: { width: 28, height: 28, flexShrink: 0, display: 'flex', alignItems: 'center', justifyContent: 'center', background: 'rgba(34,197,145,0.12)', border: '1px solid rgba(34,197,145,0.42)', borderRadius: 3, color: '#54d6a8', cursor: 'pointer', padding: 0, boxSizing: 'border-box' as const },
  ...
  emptyBtnSub: { background: 'transparent', color: '#6a7390', borderColor: '#1e2230' },
  ...
  smartFolderDeleteBtn: { width: 28, height: 28, flexShrink: 0, display: 'flex', alignItems: 'center', justifyContent: 'center', background: 'transparent', border: 'none', borderRadius: 3, color: '#9aa3ba', cursor: 'pointer', padding: 0, lineHeight: 1 },
  ...
  tagModeBtn: { height: 18, display: 'inline-flex', alignItems: 'center', justifyContent: 'center', background: 'none', border: 'none', cursor: 'pointer', fontSize: 11, fontWeight: 800, padding: 0, lineHeight: 1 },
  tagClearBtn: { width: 18, height: 18, padding: 0, justifyContent: 'center', color: '#9aa3ba', lineHeight: 1 },
  ...
  searchSuggestionMeta: { flex: '1 1 auto', minWidth: 0, color: '#687188', fontSize: font.xs, fontWeight: 500, overflow: 'hidden', textOverflow: 'ellipsis', whiteSpace: 'nowrap' as const },
  searchSuggestionEmpty: { minHeight: 30, padding: '6px 12px', color: '#6a7290', fontSize: font.xs, display: 'flex', alignItems: 'center' },
  ...
  sidebarTagChip: { maxWidth: '100%', minHeight: 26, display: 'inline-flex', alignItems: 'center', gap: 6, padding: '5px 10px', background: 'rgba(23,26,35,0.6)', border: '1px solid #242a38', borderRadius: 999, color: '#8e98ad', cursor: 'pointer', fontSize: font.sm, fontWeight: 700, textAlign: 'left' as const, overflow: 'hidden', whiteSpace: 'nowrap' as const },
  sidebarTagChipText: { display: 'block', minWidth: 0, overflow: 'hidden', textOverflow: 'ellipsis', whiteSpace: 'nowrap' as const },
  sidebarTagChipActive: { background: 'rgba(34,197,145,0.12)', border: '1px solid rgba(34,197,145,0.45)', color: '#54d6a8' },
  ...
  addTagChip: { height: 28, boxSizing: 'border-box' as const, display: 'inline-flex', alignItems: 'center', padding: '0 10px', background: 'transparent', border: '1px dashed #303747', borderRadius: 999, color: '#8e98ad', fontSize: font.sm, fontWeight: 700, cursor: 'pointer', lineHeight: 1 },
  ...
  toastActionBtn: { flexShrink: 0, height: 28, padding: '0 10px', background: 'rgba(232,236,248,0.08)', border: '1px solid rgba(232,236,248,0.16)', borderRadius: 3, color: '#f7f9ff', cursor: 'pointer', fontSize: font.sm, fontWeight: 800, whiteSpace: 'nowrap' as const },
  toastInfo: {},
  toastSuccess: {},
  toastWarning: {},
  toastError: {},
  ...
  taskCancelBtn: { flexShrink: 0, height: 28, padding: '0 10px', background: 'rgba(232,236,248,0.08)', border: '1px solid rgba(232,236,248,0.16)', borderRadius: 3, color: '#f7f9ff', cursor: 'pointer', fontSize: font.sm, fontWeight: 800, whiteSpace: 'nowrap' as const },
