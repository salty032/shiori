...
const s: Record<string, React.CSSProperties> = {
  ...
  stepNumber: { flexShrink: 0, width: control.sm, height: control.sm, display: 'flex', alignItems: 'center', justifyContent: 'center', borderRadius: 999, background: 'rgba(var(--accent-rgb), 0.14)', border: '1px solid rgba(var(--accent-rgb), var(--edge-base))', color: 'var(--accent-text)', fontSize: font.sm, fontWeight: weight.strong },
  ...
  primaryBtn: { height: control.lg, padding: '0 13px', background: 'rgba(var(--accent-rgb), 0.16)', border: '1px solid rgba(var(--accent-rgb), var(--edge-base))', borderRadius: radius.md, color: 'var(--accent-text)', cursor: 'pointer', fontSize: font.sm, fontWeight: weight.medium },
  ...
  closeAction: { flexShrink: 0, height: control.lg, padding: '0 14px', background: 'rgba(var(--accent-rgb), 0.16)', border: '1px solid rgba(var(--accent-rgb), var(--edge-base))', borderRadius: radius.md, color: 'var(--accent-text)', cursor: 'pointer', fontSize: font.sm, fontWeight: weight.medium },
}
