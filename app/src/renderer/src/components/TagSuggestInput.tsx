...
const s: Record<string, React.CSSProperties> = {
  ...
  tagInput: { flex: 1, minWidth: 0, height: 32, background: 'var(--bg-surface)', border: '1px solid var(--border-strong)', borderRadius: radius.md, color: 'var(--text-primary)', padding: '0 10px', fontSize: font.base, outline: 'none', boxSizing: 'border-box' as const },
  tagAddBtn: { width: 34, height: 32, padding: 0, background: 'rgba(var(--success-rgb), 0.12)', border: '1px solid rgba(var(--success-rgb), 0.42)', borderRadius: radius.md, color: 'var(--success)', cursor: 'pointer', fontSize: 16, lineHeight: 1, flexShrink: 0 },
