...
const s: Record<string, React.CSSProperties> = {
  ...
  tagAddBtn: { width: 34, height: control.lg, padding: 0, background: 'rgba(var(--success-rgb), 0.12)', border: '1px solid rgba(var(--success-rgb), var(--edge-base))', borderRadius: radius.md, color: 'var(--success)', cursor: 'pointer', fontSize: 16, lineHeight: 1, flexShrink: 0 },
