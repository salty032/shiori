// Web デモ版のエントリ。src/renderer/src/demo/ ではなくここに置いているのは、Vite の
...
//
// App を **動的 import** にしているのは順序のため。Electron 版は preload が
// renderer より先に走るので window.api は常に存在するが、Web 版はこのファイル自身が
// 用意する側になる。静的 import はトップへ巻き上げられるので、モジュール評価時に
// window.api を掴むコードが App 以下にあると undefined を掴んでしまう。
import { StrictMode } from 'react'
import { createRoot } from 'react-dom/client'
import '../src/renderer/global.css'
import { installMockApi } from '../src/renderer/src/demo/mockApi'
